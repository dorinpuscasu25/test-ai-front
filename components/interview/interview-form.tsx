...
const formSchema = z.object({
  ...
  interviewLanguage: z
    .string()
    .min(1, { message: "Please select an interview language" }),
        ...
        <Form {...form}>
          ...
          >
                ...
                <FormItem>
                  <div className="mb-2">
                    ...
                    <FormDescription className="text-gray-400">
                      Select the programming languages relevant to this
                      interview
                    </FormDescription>
                  </div>
            ...
            <div className="space-y-3">
              <Label htmlFor="cv" className="text-gray-200">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription className="text-gray-400">
                    Providing the job description helps tailor the interview
                    experience
                  </FormDescription>
                  <FormMessage />
                </FormItem>
